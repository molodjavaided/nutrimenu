...
> **NutriMenu — RU-контекст:** правила ниже заточены под английский. UI и меню NutriMenu — русскоязычные.
> Правило «No em dashes» держим (тире через запятую/двоеточие). Но проверки на англ. buzzwords и
> aphoristic-cadence применяй к русскому по смыслу, а не буквальным словам. Бренд-цвета проекта уже
> зафиксированы (`#2C2950`, `#B0A6DF`, `#EAE7F8`, `#FEFEF2`) — раздел «New projects only» не применять,
> identity-preservation побеждает.
