...
## Related Skills (NutriMenu)

- **`web-design`** / **`impeccable`** — исследовательские находки → решения по UI дашборда и публичного меню.
- **`frontend-design`** — воплощение персон/джорни в конкретных экранах.
- **`office-hours`** (gstack) — перед новой фичей: сверить с реальностью спроса до проектирования.

**Контекст проекта:** две аудитории — владельцы кафе/ресторанов (дашборд) и их гости (меню по QR).
Персоны и джорни строй под них, не под абстрактный B2B SaaS.
