...
export default function IngredientsClient({ initialPersonalIngredients }: { initialPersonalIngredients: IngredientRef[] }) {
  const [libraries, setLibraries] = useState<IngredientLibrary[]>(() => {
    const personalLib = { id: MY_LIBRARY_ID, name: 'Мои ингредиенты', isSystem: false, ingredients: initialPersonalIngredients }
  ...
  useEffect(() => {
    // enrich-limit оставляем клиентским — не критично для first paint
