...
function ComputedNutriSummary({ s }: { s: ItemFormState }) {
  ...
  return (
    <GlassCard tone="tinted" padding="sm" className="flex items-center gap-3 flex-wrap">
            ...
            {s.photo ? (
              <div className="relative shrink-0">
                ...
                <img
                  ...
                  style={{ border: '0.5px solid rgba(255,255,255,0.5)', boxShadow: 'var(--shadow-soft-sm)' }}
                  onError={() => {
                ...
                {(['top', 'center', 'bottom'] as const).map(pos => {
                  ...
                  return (
                    <button
                      ...
                      style={active
                        ? { background: 'var(--color-text-primary)', color: '#FEFEF2', boxShadow: 'var(--shadow-soft-sm)' }
