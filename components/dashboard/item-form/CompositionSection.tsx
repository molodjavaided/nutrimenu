  ...
  return (
    <>
      <HelpHint title="Что такое 🔒 замок и обработка?" className="mb-3">
        ...
        <p><b>🔥 Обработка</b> — способ приготовления (жарка/варка/тушение). Нажмите «Обработка» под ингредиентом. КБЖУ автоматически пересчитывается с учётом потери или прибавки веса. Например: жарка добавляет масло (поглощается), варка убирает воду.</p>
      </HelpHint>
